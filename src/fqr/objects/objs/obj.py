...
class Object(ObjectBase):
    ...
    * Ideally, objects should be 1:1 with their counterparts in the \
    ...
    class Pet(fqr.Object):
        ...
        id_: fqr.Field[str] # Trailing underscores are special
                             # in fqr, check the documentation
                             # below for more detail.
        name: fqr.Field[str] = 'Fido'  # Setting = 'Fido' will mean that
                                       # all Pet() instances will be
                                       # named 'Fido' by default.
        type: fqr.Field[str]  # You can make a field 'required' by
